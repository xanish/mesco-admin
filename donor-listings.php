...
if($_SESSION['user'] == true){
   ...
   <html>
   <head>
      <title>MESCO | Admin | List Of Donors</title>
         ...
         <div class="row content-container">
            ...
            <div class="container-fluid">
               <div class="side-body padding-top">
                  <h2 style="margin-bottom: 20px;">List of Available Donors</h2>
                  ...
                  <table id="donors" class="table table-bordered table-striped">
                     ...
                     <tbody>
                        ...
                        foreach($entries as $entry){
                           ...
                           echo '<td><a href="donor-collection-details.php?_id='.$entry['_id'].'"><span class="fa fa-mail-reply"></span> View</a></td>';
                           echo '<td><a href="edit-donor-details.php?_id='.$entry['_id'].'"><span class="fa fa-edit"></span> Edit</a></td>';
                           echo '</tr>';
                        }
               ...
               <a class="floating-button" href="add-donor.php">
