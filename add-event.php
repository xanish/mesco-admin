         ...
         <div class="row content-container">
            ...
            <div class="container-fluid">
               <div class="side-body padding-top">
                  ...
                  <form method="post" action="php/submit-event-details.php" enctype="multipart/form-data">
                     <div class="form-group">
                        <div class="input-group">
                           <span class="input-group-addon" id="name-addon"><span class="fa fa-bookmark"></span></span>
                           <input class="form-control input-lg" type="text" name="title" placeholder="Event Title" aria-describedby="name-addon">
                        </div>
                     </div>
                        ...
                        <div class="row" style="height: 46px; margin-top: 25px; margin-bottom: 25px;">
                           <div class="form-group col-lg-6 col-md-6">
                              ...
                              <div class="input-group">
                                 ...
                                 <input id="strt" class="form-control input-lg" type="date" name="start-date" aria-describedby="strt-addon">
                              </div>
                           </div>
                           <div class="form-group col-lg-6 col-md-4">
                              ...
                              <div class="input-group">
                                 ...
                                 <input class="form-control input-lg" type="date" name="end-date" aria-describedby="end-addon">
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        <div class="input-group">
                           ...
                           <textarea class="form-control input-lg" name="desc" placeholder="Event Description" aria-describedby="desc-addon"></textarea>
                        </div>
                     </div>
